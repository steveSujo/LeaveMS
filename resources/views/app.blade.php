...
<head>
    ...
    <link rel="icon" type="image/x-icon" href="{{ asset('LeMS Design/assets/img/favicon.png') }}">

    <link rel="stylesheet" href="{{ asset('LeMS Design/assets/css/bootstrap.min.css') }}">



    <link rel="stylesheet" href="{{ asset('LeMS Design/assets/css/lnr-icon.css') }}">
    <link rel="stylesheet" href="{{ asset('LeMS Design/assets/css/font-awesome.min.css') }}">
    <link rel="stylesheet" href="{{ asset('LeMS Design/assets/css/style.css') }}">
    <script src="{{ asset('LeMS Design/assets') }}/js/jquery-3.2.1.min.js"></script>
    @yield('head')
</head>

<body>
    @sectionMissing('appContent')
                    ...
                    <div class="row align-items-center">
                        <div class="col-lg-3 col-md-3 col-sm-3 col-6">
                            <div class="logo my-3 my-sm-0">
                                <a href="index.html">
                                    <img src="{{ asset('LeMS Design/assets/') }}/img/logo.png"
                                        style="border-radius: 15%;" alt="logo image" class="img-fluid" width="100">
                                </a>
                            </div>
                        </div>
                                        ...
                                        <div class="user-info align-right dropdown d-inline-block header-dropdown">
                                            <a href="javascript:void(0)" data-toggle="dropdown"
                                                ...
                                                <div class="user-avatar d-inline-block">
                                                    <img src="{{ asset('LeMS Design/assets/') }}/img/profiles/img-6.jpg"
                                            ...
                                            <div
                                                ...
                                                <a class="dropdown-item p-2" href="admin.html">
                                                    <span class="media align-items-center">
                            ...
                            <div class="user-card card shadow-sm bg-white text-center ctm-border-radius grow">
                                <div class="user-info card-body">
                                    <div class="user-avatar mb-4">
                                        <img src="{{ asset('LeMS Design/assets/') }}/img/profiles/img-13.jpg"
                                ...
                                <div class="card ctm-border-radius shadow-sm border-none grow">
                                    <div class="card-body">
                                        <div class="row no-gutters">
                                            ...
                                            <div class="col-6 align-items-center shadow-none text-center">
                                                <a href="employees-list" class="text-dark p-4 ctm-border-right"><span
