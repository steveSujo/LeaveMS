...
@section('sidebar')
    <x-sidebar page='dashboard' />
@endsection
@section('content')
    <x-heading-with-bread>
        Employees
    </x-heading-with-bread>
    {{-- <h1 class="font-bold text-xl mb-3 mt-5 text-slate-600">Employees</h1> --}}
                ...
                @foreach ($list as $emp)
                    <tr class="bg-white dark:bg-gray-800 hover:bg-gray-50 dark:hover:bg-gray-600">
                        ...
                        <th scope="row"
                            ...
                            <img class="w-10 h-10 rounded-full" src="{{ asset('images/img-9.jpg') }}" alt="Jese image">
                            <div class="pl-3">
                        ...
                        <td class="px-6 py-4">
                            <!-- Modal toggle -->
                            <a href="#" type="button"
                                data-modal-show="editUserModal"data-modal-target="editUserModal"
